...
class linksTableViewController: UITableViewController {
   ...
   // let logoIconsImageArray = [UIImage(named: "esquire_logo"), UIImage(named: "esquire_logo"), UIImage(named: "esquire_logo")]
    ...
    override func viewDidLoad() {
       ...
       // linksBackgroundImageView.image = UIImage(named: "background_link")
    ...
    override func numberOfSectionsInTableView(tableView: UITableView) -> Int {
        // #warnin Incomplete implementation, return the number of sections
        return 1
    }
     ...
     override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return 1//linkContentName.count
    }
